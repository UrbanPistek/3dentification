...
CALIBRATION_FILES = [
    "./data/dataset2/bv1_id1_daytime_calibration_2023_03_05.csv",
    "./data/dataset2/bv1_id2_late_afternoon_calibration_2023_03_05.csv",
    "./data/dataset2/bv1_id3_daytime_calibration_2023_03_06.csv",
    "./data/dataset2/bv1_id4_late_afternoon_calibration_2023_03_15.csv",
    "./data/dataset2/bv1_id5_afternoon_calibration_2023_03_19.csv"
]

SYNTHETIC_DATA_X = "./data/synthetic/synthetic_abs_pla_empty_non_plastics_petg_plastics_2023_03_22_size_10012_bal_X.npy"
SYNTHETIC_DATA_Y = "./data/synthetic/synthetic_abs_pla_empty_non_plastics_petg_plastics_2023_03_22_size_10012_bal_y.npy"

# Load colour data
COLOUR_DATA = "./data/dataset2/colours.json"
...
def get_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser.parse_args:
    ...
    parser.add_argument(
        ...
        "--execute", 
        action='store_true',
        help='Run actions in the script')
